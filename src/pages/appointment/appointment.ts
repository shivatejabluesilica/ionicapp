...
export class AppointmentPage {
    ...
    constructor(navParams: NavParams, public loginService: LoginService){
    ...
    appointment(){
        if(this.doctor === null ||this.doctor === '' ||this.doctor === undefined || this.dt === null ||
        this.dt === '' || this.timing === null || this.timing === ''){
            this.msg ='Failed';
        }
        else{
            let obj = { doc:this.doctor,dep:this.department,date:this.dt,time:this.timing};
            this.loginService.appointment(obj,this.obj._id).subscribe(data =>{ console.log(data)})
            this.msg = 'Success';
            this.doctor = '';
            this.department ='';
            this.timing = '';
